...
class ImageTestClass(TestCase):
    ...
    def test_filter_by_location(self):
        self.new_image.save_image()
        img_location = Image.filter_by_location(
            self.new_image.img_location == img_location)
    ...
    def test_search_image_by_category(self):
        self.new_image.save_image()
        image_category = Image.search_image_by_category(
            self.new_image.img_category.category)
